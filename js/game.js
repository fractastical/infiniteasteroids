...
const Achievements = {
  reach_wave_2: {
    reached: false,
    icon: "achievements/whitehat.png",
    description: "Reach Wave 2. Unlock Turret and Bomber Drone.",
  },
  reach_wave_5: {
    reached: false,
    icon: "achievements/cyberpunk.png",
    description: "Reach Wave 5. Unlock Freeze and Cluster Bomb.",
  },
  // reach_wave_57: { reached: false, icon: 'achievements/whitehat.png', description: 'Reach Wave 7' },
  reach_wave_10: {
    reached: false,
    icon: "achievements/angelcapitan.png",
    description: "Reach Wave 10. Unlock Sonic Blast.",
  },
  ...
  destroy_100_asteroids: {
    reached: false,
    icon: "achievements/speedy.png",
    description: "Destroy 100 Asteroids in One Game. Unlock Drone.",
  },
  destroy_1000_asteroids: {
    reached: false,
    icon: "achievements/speedy.png",
    description: "Destroy 1000 Asteroids in One Game. Unlock Damage Booster.",
  },

  // destroy_500_asteroids: { reached: false, icon: 'achievements/_5973.png', description: 'Destroy 500 Asteroids in One Game' },
  complete_easy_mode: {
    reached: false,
    icon: "achievements/onthemoon.png",
    description: "Reach Wave 30 Deep Space Easy. Unlock Boomerang.",
  },
  complete_normal_mode: {
    reached: false,
    icon: "achievements/insanecat.png",
    description: "Reach Wave 30 Deep Space Normal. Unlock Acid Bomb.",
  },
  acid_bomb_damage: {
    reached: false,
    damage: 0,
    required: 2500,
    icon: "achievements/acid.png",
    description: "Deal 2,500 Damage with Acid Bomb. Unlock Flamethrower.",
  },
  laser_damage: {
    reached: false,
    damage: 0,
    required: 2500,
    icon: "achievements/deathray2.png",
    description: "Deal 2,500 Damage with Laser. Unlock Explosive Laser.",
  },
  drone_damage: {
    reached: false,
    damage: 0,
    required: 1500,
    icon: "achievements/storm_drone.png",
    description: "Deal 1,500 Damage with Drone. Unlock Drone Army.",
  },
  explosive_laser_damage: {
    reached: false,
    damage: 0,
    required: 5000,
    icon: "achievements/explosive.png",
    description: "Deal 5,000 Damage with Explosive Laser. Unlock Void Warden.",
  },
  death_ray_damage: {
    reached: false,
    damage: 0,
    required: 10000,
    icon: "achievements/deathray.png",
    description: "Deal 10,000 Damage with Death Ray. Unlock Extra Choice.",
  },
  no_lives_lost: {
    reached: false,
    icon: "achievements/orpheus.png",
    description: "Wave 50 with No Lives Lost. Unlock Nano Swarm.",
  },
  complete_hard_mode: {
    reached: false,
    icon: "achievements/explosion.png",
    description: "Deep Space Hard Wave 30. Unlock Explosive Rocket.",
  },
  complete_hero_mode: {
    reached: false,
    icon: "achievements/cyberpunk.png",
    description: "Deep Space Hero Wave 30. Unlock Extra Life.",
  },
  kill_5_aliens: {
    reached: false,
    icon: "achievements/aliensign.png",
    description: "Kill 5 Aliens. Unlock Death Ray.",
  },
  kill_50_aliens: {
    reached: false,
    icon: "achievements/aliensign.png",
    description: "Kill 50 Aliens. Unlock Chain Lightning.",
  },
  kill_500_aliens: {
    reached: false,
    icon: "achievements/aliensign.png",
    description: "Kill 500 Aliens. Unlock Sonic Boom.",
  },
  complete_meteor_easy_mode: {
    reached: false,
    icon: "achievements/meteor_one.png",
    description: "Meteor Shower Easy Mode. Unlock Starhawk.",
  },
  complete_meteor_normal_mode: {
    reached: false,
    icon: "achievements/meteor_acid.png",
    description: "Meteor Shower Normal Wave 30. Unlock Wave Turret.",
  },
  complete_meteor_hard_mode: {
    reached: false,
    icon: "achievements/meteor_small.png",
    description: "Meteor Shower Hard Wave 30. Unlock Solar Phoenix.",
  },
  complete_meteor_hero_mode: {
    reached: false,
    icon: "achievements/death_meteor.png",
    description: "Meteor Shower Hero Wave 30. Unlock Quantum Striker.",
  },
  complete_planet_easy_mode: {
    reached: false,
    icon: "achievements/planet_medium.png",
    description: "Planet Easy Mode Wave 30. Unlock Elo Bomb.",
  },
  complete_planet_normal_mode: {
    reached: false,
    icon: "achievements/storm_medium.png",
    description: "Planet Normal Mode Wave 30. Unlock Triple Turret.",
  },
  complete_planet_hard_mode: {
    reached: false,
    icon: "achievements/onthemoon.png",
    description: "Planet Hard Mode Wave 30. Unlock Glitch Effect.",
  },
  complete_planet_hero_mode: {
    reached: false,
    icon: "achievements/planet_huge.png",
    description: "Planet Hero Mode Wave 30. Unlock Asteroid Splitter.",
  },
  ...
  million_score: {
    reached: false,
    icon: "achievements/cyberpunk.png",
    description: "Get a million points. Invincibility Shield.",
  },
  wave_60_endless: {
    reached: false,
    icon: "achievements/insanecat.png",
    description: "Reach wave 60 on Endless. Piercing Laser.",
  },
  wave_120_endless: {
    reached: false,
    icon: "achievements/insanecat.png",
    description: "Reach wave 120 on Endless. Pentacule.",
  },
  space_pizza: {
    reached: false,
  ...
  purple_pixie: {
    reached: false,
    icon: "achievements/keroaccat.png",
    description: "Find the purple pixie.",
  },
  gold_pixie: {
    reached: false,
    icon: "icons/upgrades/pixie2.png",
  ...
  all_hards: {
    reached: false,
    icon: "achievements/insanecat.png",
    description: "All hard modes wave 30. Unlock Tetragrammaton.",
  },
  all_modes: {
    reached: false,
    icon: "achievements/planet_huge.png",
    description: "All game modes wave 30. Unlock Hexarose.",
  },
  dark_side: {
    reached: false,
...
function startGame() {
  ...
  if (!isMobile()) {
    if (!toggleMusicOff) backgroundMusic.play(); // Play the background music
    isMusicPlaying = true;
  }
}
...
function resizeCanvas() {
  ...
  if (window.innerHeight < 560) {
    console.log("window height under 560");
    achievementsPerPage = 3;
  }

  canvas.width = window.innerWidth;
  canvas.height = window.innerHeight;

  console.log("resize invoked!-canvas", canvas.width, canvas.height);
  console.log("resize invoked!-innersize", innerWidth, innerHeight);
  console.log("resize invoked!-oldsize", oldWidth, oldHeight);
  // TODO: not sure why we had this year
  // resetShip();
  if (window.innerWidth > 1200) fullScreenMode = true;
  ...
  if (ship) {
    ship.x *= widthRatio;
    ship.y *= heightRatio;
    console.log("ship ratiosize", widthRatio, heightRatio);
...
function toggleMusic() {
  if (!toggleMusicOff) toggleMusicOff = true;
...
function toggleSound() {
  if (!toggleSoundOff) toggleSoundOff = true;
  else toggleSoundOff = false;
}

let toggleBackgroundOff = false;

function toggleBackground() {
  if (!toggleBackgroundOff) toggleBackgroundOff = true;
  else toggleBackgroundOff = false;
}
...
function update() {
  ...
  if (spawnTimer <= 0) {
    ...
    if (wave == 10 && currentMode == GameModes.EASY) updateAchievementsAtEnd();

    if (meteorMode) {
      const side = Math.random() < 0.5 ? "left" : "right";
      showArrow(side);
    } else createAsteroids();
...
function initializeGame(mode, replay = false) {
  ...
  if (!Achievements.reach_wave_2.reached) initializeTutorial();

  if (replay) currentShip = lastCurrentShip;
  // console.log(currentShip);
  currentMode = mode;
...
document.getElementById("endScreen").addEventListener("wheel", (event) => {
  event.stopPropagation(); // Prevent parent elements from blocking scroll
});
...
function getAvailableWeaponIcons() {
  ...
  if (Achievements.alien_supermegaboss_killed.reached)
    availableIcons.push(upgradeDefinitions["Chain of Flame"].icon);
  if (Achievements.alien_megaboss_killed.reached)
    availableIcons.push(upgradeDefinitions["Explo Drone"].icon);
  if (Achievements.kill_500_aliens.reached)
    availableIcons.push(upgradeDefinitions["Sonic Boom"].icon);
  if (Achievements.alien_octopus_killed.reached)
    availableIcons.push(upgradeDefinitions["CryoBomb"].icon);
  if (Achievements.drone_damage.reached)
    availableIcons.push(upgradeDefinitions["Drone Army"].icon);
  if (Achievements.complete_meteor_normal_mode.reached)
    availableIcons.push(upgradeDefinitions["Wave Turret"].icon);
  if (Achievements.complete_planet_normal_mode.reached)
    availableIcons.push(upgradeDefinitions["Triple Turret"].icon);
...
let achievementsPerPage = 5; // Number of achievements to show per page
  ...
  Object.keys(secondaryWeapons).forEach((weaponKey) => {
    if (secondaryWeapons[weaponKey].isAvailable()) {
      availableSecondaryWeapons.push({
        key: weaponKey,
        name: secondaryWeapons[weaponKey].name,
      });
    }
  });
...
function updateAchievementsAtEnd() {
  ...
  if (megaBossAlienSpawned && megaBossAlien == null)
    addAchievement("alien_megaboss_killed");
  if (superbossAlienSpawned && superbossAlien == null)
    addAchievement("alien_supermegaboss_killed");
  if (octoBossSpawned && octoBoss == null)
  ...
  if (collectedSpacePizza) addAchievement("space_pizza");
  if (collectedPurplePixie) addAchievement("purple_pixie");
  if (collectedPinkPixie) addAchievement("pink_pixie");
  if (collectedGoldPixie) addAchievement("gold_pixie");
  if (collectedSpacePickle) addAchievement("space_pickle");
  if (collectedDarkSide) addAchievement("dark_side");
  ...
  if (damageReport.deathRay >= Achievements.death_ray_damage.required)
    addAchievement("death_ray_damage");
  if (damageReport.drones >= Achievements.drone_damage.required)
    addAchievement("drone_damage");
  if (damageReport.lasers >= Achievements.laser_damage.required)
    addAchievement("laser_damage");
...
function claimLevelUps() {
  if (
    ...
    if (upgrades.length >= 1) {
      ...
      else upgradeOptionsHTML = createUpgradeOptionsHTML(upgrades);
...
function toggleRedeemMode() {
  if (waitAndClaimMode) waitAndClaimMode = false;
  else waitAndClaimMode = true;

  let redeemText = "On";
  if (!waitAndClaimMode) redeemText = "Off";
...
function displayEndGameScreen(
  ...
  Object.entries(damageReport).forEach(([weapon, damage]) => {
    ...
    if (weaponInfo && damage > 0) {
      // Only create elements for weapons with damage > 0
